...
- Spark & DLT pipelines via `dc43.components.integration.spark_io` with schema/metric helpers from `dc43.components.integration.spark_quality` for auto-casting and contract-aware IO.
