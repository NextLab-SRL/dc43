...
2. **Validate and coerce data** using helpers from `dc43.lib.components.data_quality.integration` while respecting enforcement flags.
...
* [`dc43.lib.components.data_quality.integration`](../../src/dc43/components/data_quality/integration/__init__.py) — Schema snapshots, expectation predicates, and metric builders used by adapters.
