...
| `workspace_host` | string | Databricks workspace URL (for example `https://adb-<workspace>.azuredatabricks.net`). Populates from the wizard's *workspace URL* field when using the Delta modules. |
